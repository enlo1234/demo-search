      ...
      <main className="container mx-auto px-4 py-12 flex flex-col items-center">
        <div className="max-w-3xl w-full text-center mb-8">
          ...
          <p className="text-gray-600 mb-4">
            Enter your search term below and check the batch event. Returned search result items within the viewport will be logged and pushed when: a. BY THE TIME (= as soon as) the user clicks a result; b. 5 seconds 
          </p>
